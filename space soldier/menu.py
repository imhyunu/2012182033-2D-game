...
class Menu():
    ...
    def __init__(self):
        ...
        self.st_image = load_image('start_menu.png')
        self.so_image = load_image('sound_menu.png')
        self.ex_image = load_image('exit_menu.png')
        self.back_image = load_image('back_world.png')
