...
alien_team_data_file = open('text_file\_alien_1.txt')
alien_team_data = json.load(alien_team_data_file)
alien_team_data_file.close()
...
def creat_alien_team():
    ...
    for name in alien_team_data:
        alien = Alien()
        alien.hit_point = alien_team_data[name]['hit_point']
        team.append(alien)
